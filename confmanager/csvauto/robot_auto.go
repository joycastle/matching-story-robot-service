...
type Robot struct {
	...
	RobotCustomFinishTime []int   //表自定义活动结束时间范围
}
...
type IRobot interface {
	...
	GetRobotCustomFinishTimeLen() int
	GetRobotCustomFinishTimeByIndex(index int) int
}
...
//GetRobotCustomFinishTimeLen auto
func (r *Robot) GetRobotCustomFinishTimeLen() int {
	return len(r.RobotCustomFinishTime)
}

//GetRobotCustomFinishTimeByIndex auto
func (r *Robot) GetRobotCustomFinishTimeByIndex(index int) int {
	return r.RobotCustomFinishTime[index]
}
